    ...
    <?php if(is_page_template('page_home.php'))
            { ?>
                <div class="tituloHotel">
                        <img src="<?php echo (bloginfo("url") . "/img/divisor_amarelo_classico_2.png")?>" id="hoteis" alt=""><br><br><img src="<?php echo (bloginfo("url") . "/img/Hoteis.png")?>" alt="">
                </div>
                ...
                <div class="tituloServicos">
                        <img src="<?php echo (bloginfo("url") . "/img/divisor_amarelo_classico_2.png")?>" id="servicos" alt=""><br><br><img src="<?php echo (bloginfo("url") . "/img/Servicos.png")?>" alt="">
                </div>
                ...
                <div class="tituloDicas">
                        <img src="<?php echo (bloginfo("url") . "/img/divisor_amarelo_classico_2.png")?>" id="dicas" alt=""><br><br><img src="<?php echo (bloginfo("url") . "/img/Dicas.png")?>" alt="">
                </div>
