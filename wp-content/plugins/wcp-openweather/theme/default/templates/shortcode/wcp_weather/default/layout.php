...
?>
<div id="<?php echo $settings['id']; ?>" class="wcp-openweather-default-shortcode wp-open-weather wpw-shortcode wcp-openweather-primary-background wcp-openweather-primary-color">
